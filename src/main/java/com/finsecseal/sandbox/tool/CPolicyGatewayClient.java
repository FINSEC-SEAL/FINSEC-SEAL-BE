    ...
    public GatewayResult invoke(SandboxExecutionContext context, ToolInvocation invocation, String actorId) {
        ...
        ExecutionEventDto.Event policyEvent = eventService.append(
            ...
            new ExecutionEventDto.AppendRequest(
                ...
                policyJson,
                decision.reasonCode(),
                objectMapper.createObjectNode().put("gateway", "c")
            ),
            actorId
        );
        ...
        responseMetadata.put("gateway", "c");
            ...
            try {
                ...
                if (attempt == 3) {
                    throw new BusinessException(ErrorCode.INTERNAL_ERROR,
                            "C Policy Gateway call failed after retries: " + ex.getClass().getSimpleName());
                }
            }
        }
        throw last == null
